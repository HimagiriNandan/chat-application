...
const MessageBar = () => {
  ...
  const {selectedChatType, selectedChatData, userInfo, setUploading, setFileUploadProgress} = useAppStore();
  ...
  const handleAttachmentChange = async(event) => {
    try{
      ...
      if(file){
        ...
        setUploading(true);
        const res = await apiClient.post(UPLOAD_FILE_ROUTE, formData, {withCredentials: true, onUploadProgress: data=>{
