...
function CreateChannel() {
  ...
  useEffect(() => { //to get the list of all contacts...
    const getData = async() => {
  ...
  return (
    <>
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger><FaPlus className="text-neutral-400 font-light text-opacity-90 text-start hover:text-neutral-100 cursor-pointer transition-all duration-300" onClick={() => setNewChannelModal(true)}/></TooltipTrigger>
